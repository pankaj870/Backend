...
/**
 * Bean definitions for {@link TodoRepository}.
 */
@Generated
public class TodoRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'todoRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getTodoRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'todoRepository'.
   */
  public static BeanDefinition getTodoRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, TodoRepository.class, TodoItems.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.example.todo.repository.TodoRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.TodoRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.example.todo.repository.TodoRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getTodoRepositoryInstanceSupplier();
